...
public class AddGst extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {// Step 1 load the driver
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/wallmart", "root",
					"<YourPassword>");

			// Step 3 create Object of PrepareStatemnt Interface to Execute Query;
			PreparedStatement st = con
					.prepareStatement("insert into gstRegistration values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
			...
			response.getWriter()
					.write("<h3>Your Registration has done Successfully!</h3><hr/><a href='index.jsp'>Home</a>");
